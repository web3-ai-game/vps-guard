...
type Page = 'device' | 'teammate' | 'ai' | 'audit' | 'tasks' | 'do' | 'settings' | 'ops' | 'bot'
...
export default function App() {
  ...
  const NAV: { id: Page; label: string; icon: string; color: string }[] = [
    ...
    { id: 'bot',      label: 'Bot 通訊',   icon: '📡',  color: 'teal' },
  ...
  const activeColor: Record<string, string> = {
    ...
    teal:    'bg-teal-950/70 text-teal-300 border-teal-700/80 shadow-teal-900/30',
